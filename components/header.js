    ...
    <header className="sticky twitter-blue mx-auto py-3 px-5 flex">
      ...
      <nav className="flex space-x-5 h-12 ml-12 text-lg items-center text-white">
        ...
        <div className="relative group h-12">
          <button className="hover:text-gray-300 h-12">
            程式基礎教學
          </button>
          <hr className="hidden group-hover:block absolute h-1 bg-white w-full"></hr>
          <ul className="hidden group-hover:block mt-1 divide-y-2 absolute bg-white text-black w-auto px-6">
